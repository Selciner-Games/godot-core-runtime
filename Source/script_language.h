...
// Jenova Script Language Definition
...
// Jenova Header Language Definition
class CPPHeaderLanguage : public ScriptLanguageExtension
{
	GDCLASS(CPPHeaderLanguage, ScriptLanguageExtension);
...
public:
	static void init();
	static void deinit();
	static CPPHeaderLanguage* get_singleton();
